...
Este modulo é o "coração" do projeto. Ele orquestra todas as pecas:
...
Ordem de prioridade para o LLM:
  1. Modelo fine-tunado localmente
...
# O contexto é preenchido automaticamente pelo retriever RAG.
# A instrucao de responder em portugues e importante porque o MedQuAD é em ingles,
