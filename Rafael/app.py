...
/* Toda a árvore de containers da página */
.gradio-container,
.gradio-container > *,
.gradio-container > * > *,
.gradio-container > * > * > * {
...
def build_interface():
    with gr.Blocks(css=CSS, title="Analise de Audio — Análise Clínica de Áudio") as demo:
